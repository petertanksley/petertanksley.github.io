...
![](www/hex/responders.png){fig-alt="Pixel-art hex sticker: a bronze tri-service challenge coin standing on edge on a stone ledge, a lit candle beside it."}
:::
...
::: {.hex-mark .hex-mark--section}
![](www/hex/criminology.png){fig-alt="Pixel-art hex sticker: a pair of heavy iron handcuffs lying on a wooden table, one small iron key beside them and a lit candle behind."}
:::
